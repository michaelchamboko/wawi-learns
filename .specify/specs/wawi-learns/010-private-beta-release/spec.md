...
- **AC-SLC-010-003:** Protected `main` requires the PRD §42.2 checks; Vercel Git integration targets existing project `wawi-learns` and Convex uses controlled environment-specific deployment.
...
No release with partial P0 evidence, preview called production, direct push around protection, unreviewed generated content, production data in tests or post-Version 1 feature.
